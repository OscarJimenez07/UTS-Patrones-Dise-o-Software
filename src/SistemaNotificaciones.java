 ...
 *
 * Contiene:
 * - Target (NotificacionJuego): interfaz que el motor de juegos espera
 * - Adaptees (ServicioDiscord, ServicioCorreo): servicios externos con interfaces incompatibles
 * - Adapters (AdaptadorDiscord, AdaptadorCorreo): adaptan los servicios externos a la interfaz del juego
 */
...
// ══════════════════════════════════════════════
// ADAPTEE 2: servicio externo de Correo Electronico.
// Tiene su propia interfaz incompatible con NotificacionJuego.
// ══════════════════════════════════════════════
...
// Traduce las llamadas del juego al formato de email.
// ══════════════════════════════════════════════
